...
//  alert ('Hello... I can run JS through my web browser code')

//  {
    //     console.log('Hello... I can run JS through my web browser code')    
    // }
...
// let email = "abdulrahimrind022@gmail.com";
...
// let nam = "Abdul Rahim Rind", age = 22, city = "Karachi";
...
// document.write("Multiplication Table for 5");
// document.write("<br>")
// document.write("<br>")
// document.writeln(" 5 x 1 = 5");
// document.write("<br>")
// document.writeln(" 5 x 2 = 10");
// document.write("<br>")
// document.writeln(" 5 x 3 = 15");
// document.write("<br>")
// document.writeln(" 5 x 4 = 20");
// document.write("<br>")
// document.writeln(" 5 x 5 = 25");
// document.write("<br>")
// document.writeln(" 5 x 6 = 30");
// document.write("<br>")

// document.writeln(" 5 x 7 = 35");
// document.write("<br>")

// document.writeln(" 5 x 8 = 40");
// document.write("<br>")

// document.writeln(" 5 x 9 = 45");
// document.write("<br>")

// document.writeln(" 5 x 10 = 50");
...
// function greetUser (){
//     if( h1.innerHTML === 'change through js'){
//         h1.innerHTML = 'hello pakistan'
//     }else{
//         h1.innerHTML = 'change through javaS'
//     }
...
//  if ( clock >= 07 && clock < 12 )
// { 
//     console.log( 'Morning time' );
// }
// else if( clock >= 12 && clock < 19 )
// { 
//     console.log( 'lunch time' );
// }
// else if( clock >= 20 && clock < 24 )
// { 
//     console.log( 'Diner time' );
// }
// else
// {
//     console.log( 'sleping time' );
// }
...
// let price1 = +prompt("Cricket bat price Rs.");
// let price2 = +prompt("boll price Rs.");
// let p1 = +prompt("Cricket kit price Rs.");
// let p2 = +prompt("Cricket bag price Rs.");

// function myName(price , price , p , p ){
//     let myName =" Cricket bat price is " +  price1  + " Boll price is " +  price2  + " Cricket kit price is " +  p1 + " Cricket bag price is " + p2  ; 
//     return myName;
//    }
//     console.log(myName());
